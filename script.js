...
btnScrollTo.addEventListener('click', function(e) {
  ...
  // SCROLLING
  // window.scrollTo(
  //   s1coords.left + pageXOffset, s1coords.top + window.pageYOffset
  //   );
...
// console.log(message.style.height = Number.parseFloat(getComputedStyle(message).
// height, 10) + 30 + 'px');
